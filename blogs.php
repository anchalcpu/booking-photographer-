...
$query1="select *  from blogs where status =1";
...
<?php echo $data["category"]?>
                            ...
                            <img src="profiles/img/blog/<?php echo $data["img"]?>" alt="" style="height:250px;">
                        </div>
                        <div class="property_content">
                            <div class="main_pro">
                                    <h3><?php echo $data["title"]?></h3>
                                    
                                   <a href="single-blog.php?blog_no=<?php echo $data["id"];?>"> <span class="amount">Read More -></span><a>
                            </div>
                        </div>
